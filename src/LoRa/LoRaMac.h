...
class LoRaMac : public MACProtocolBase
{
  ...
  protected:
    ...
    //@}
    LoRaAppPacket* lastSendedMessage = nullptr;
  ...
  public:
    int numberOfLeftDataMessages = -1;
    void turnOnReceiver(void);
    void turnOffReceiver(void);
    void setParentAddress(DevAddr address);
    /**
  ...
  protected:
    ...
    bool isSynchMessage(cMessage *msg);
    bool isDataMessage(cMessage *msg);
    bool isAcknowledgeMessage(cMessage *msg);
    //@}
};
